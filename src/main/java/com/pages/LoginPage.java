...
public class LoginPage extends TestBase{
	...
	@FindBy(xpath="//span[text()='New AnalytiQs']")
	WebElement newAnalytiQsBTN;
	...
	public DashBoardPage login(String un, String pwd){
		...
		GenericLibrary.waitForElementToBeClickable(driver, newAnalytiQsBTN);
		JavascriptLibrary.javascriptClickElement(driver, newAnalytiQsBTN);
